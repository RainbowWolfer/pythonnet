...
namespace Python.Runtime
{
    ...
    internal delegate int GetBufferProc(BorrowedReference obj, out Py_buffer buffer, PyBUF flags);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void ReleaseBufferProc(BorrowedReference obj, ref Py_buffer buffer);
}
