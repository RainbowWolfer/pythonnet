    ...
    internal class Converter
    {
        ...
        internal static NewReference ToPython(object? value, Type type)
        {
            ...
            switch (tc)
            {
                ...
                case TypeCode.Char:
                    return Runtime.PyUnicode_FromOrdinal((char)value);
        ...
        private static object? ToPyObjectSubclass(ConstructorInfo ctor, PyObject instance, bool setError)
        {
            try
            {
        ...
        internal static bool ToPrimitive(BorrowedReference value, Type obType, out object? result, bool setError)
        {
            ...
            switch (tc)
            {
                ...
                case TypeCode.Byte:
                {
                    if (Runtime.PyObject_TypeCheck(value, Runtime.PyBytesType))
                    {
                        if (Runtime.PyBytes_Size(value) == 1)
                        {
                            ...
                            result = Marshal.ReadByte(bytePtr);
                            return true;
                        }
                        goto type_error;
                    }
                    ...
                    if (num is > byte.MaxValue or < byte.MinValue)
                    {
                        goto overflow;
                    }
                    result = (byte)num;
                ...
                case TypeCode.SByte:
                {
                    ...
                    if (num is > sbyte.MaxValue or < sbyte.MinValue)
                    {
                        goto overflow;
                    }
                    result = (sbyte)num;
                ...
                case TypeCode.Char:
                {
                    ...
                    if (num is > char.MaxValue or < char.MinValue)
                    {
                        goto overflow;
                    }
                    result = (char)num;
                ...
                case TypeCode.Int16:
                {
                    ...
                    if (num is > short.MaxValue or < short.MinValue)
                    {
                        goto overflow;
                    }
                    result = (short)num;
                ...
                case TypeCode.UInt16:
                {
                    ...
                    if (num is > ushort.MaxValue or < ushort.MinValue)
                    {
                        goto overflow;
                    }
                    result = (ushort)num;
                ...
                case TypeCode.Single:
                {
                    ...
                    if (num is > float.MaxValue or < float.MinValue)
                    {
